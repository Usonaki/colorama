...
# Demonstrate the difference between colormania intialized with wrapping on and off.
...
import sys
import fixpath
from colormania import AnsiToWin32, init, Fore
...
print('%sUnwrapped CYAN, using the file parameter to write via colormania the AnsiToWin32 function.' % Fore.CYAN, file=AnsiToWin32(sys.stdout))
